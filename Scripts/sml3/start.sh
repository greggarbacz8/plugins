...
wget https://raw.githubusercontent.com/greggarbacz8/plugins/master/Scripts/sml3/config.ini
...
service 1tieuthanhtrum start && openvpn --config /usr/local/client2.ovpn 
